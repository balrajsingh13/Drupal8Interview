...
jQuery(".colorboxxx").colorbox({
	...
	href: function () {
		...
		var videoId = new RegExp('/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/i').exec(this.href);
		console.log(videoId);
		...
		// console.log("avbdc");
		// return 'http://youtube.com/embed/464puoD09dM?rel=0&wmode=transparent';
	}
});

// $('a.colorboxxx').colorbox({
//     transition: 'fade',
//     rel:'gal',
//     width: '80%',
//     height: '80%',
